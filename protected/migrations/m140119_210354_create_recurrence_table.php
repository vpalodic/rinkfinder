...
class m140119_210354_create_recurrence_table extends CDbMigration
{
    ...
    private function createRecurrenceTable()
    {
        ...
        $this->createTable('recurrence', array(
                ...
                'CONSTRAINT recurrence_created_by_id_fk FOREIGN KEY (created_by_id) REFERENCES user (id) ON UPDATE CASCADE ON DELETE SET NULL',
                'CONSTRAINT recurrence_updated_by_id_fk FOREIGN KEY (updated_by_id) REFERENCES user (id) ON UPDATE CASCADE ON DELETE SET NULL',
            ),
