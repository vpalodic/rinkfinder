...
class m140118_205701_create_arena_and_location_table extends CDbMigration
{
    ...
    private function createArenaStatusTable()
    {
        ...
        $this->createTable('arena_status', array(
                ...
                'CONSTRAINT arena_status_created_by_id_fk FOREIGN KEY (created_by_id) REFERENCES user (id) ON UPDATE CASCADE ON DELETE SET NULL',
                'CONSTRAINT arena_status_updated_by_id_fk FOREIGN KEY (updated_by_id) REFERENCES user (id) ON UPDATE CASCADE ON DELETE SET NULL',
            ),
    ...
    private function createArenaTable()
    {
        ...
        $this->createTable('arena', array(
                ...
                'CONSTRAINT arena_created_by_id_fk FOREIGN KEY (created_by_id) REFERENCES user (id) ON UPDATE CASCADE ON DELETE SET NULL',
                'CONSTRAINT arena_updated_by_id_fk FOREIGN KEY (updated_by_id) REFERENCES user (id) ON UPDATE CASCADE ON DELETE SET NULL',
            ),
    ...
    private function createLocationTypeTable()
    {
        ...
        $this->createTable('location_type', array(
                ...
                'CONSTRAINT location_type_created_by_id_fk FOREIGN KEY (created_by_id) REFERENCES user (id) ON UPDATE CASCADE ON DELETE SET NULL',
                'CONSTRAINT location_type_updated_by_id_fk FOREIGN KEY (updated_by_id) REFERENCES user (id) ON UPDATE CASCADE ON DELETE SET NULL',
            ),
            'ENGINE = InnoDB DEFAULT CHARSET = utf8 COLLATE = utf8_unicode_ci AUTO_INCREMENT = 6'
        );
    }
    ...
    private function createLocationBaseTable()
    {
        ...
        $this->createTable('location_base', array(
                ...
                'CONSTRAINT location_base_created_by_id_fk FOREIGN KEY (created_by_id) REFERENCES user (id) ON UPDATE CASCADE ON DELETE SET NULL',
                'CONSTRAINT location_base_updated_by_id_fk FOREIGN KEY (updated_by_id) REFERENCES user (id) ON UPDATE CASCADE ON DELETE SET NULL',
            ),
            'ENGINE = InnoDB DEFAULT CHARSET = utf8 COLLATE = utf8_unicode_ci AUTO_INCREMENT = 6'
        );
        /**
    ...
    private function createLocationRefrigerationTable()
    {
        ...
        $this->createTable('location_refrigeration', array(
                ...
                'CONSTRAINT location_refrigeration_created_by_id_fk FOREIGN KEY (created_by_id) REFERENCES user (id) ON UPDATE CASCADE ON DELETE SET NULL',
                'CONSTRAINT location_refrigeration_updated_by_id_fk FOREIGN KEY (updated_by_id) REFERENCES user (id) ON UPDATE CASCADE ON DELETE SET NULL',
            ),
            'ENGINE = InnoDB DEFAULT CHARSET = utf8 COLLATE = utf8_unicode_ci AUTO_INCREMENT = 6'
        );
        /**
    ...
    private function createLocationResurfacerTable()
    {
        ...
        $this->createTable('location_resurfacer', array(
                ...
                'CONSTRAINT location_resurfacer_created_by_id_fk FOREIGN KEY (created_by_id) REFERENCES user (id) ON UPDATE CASCADE ON DELETE SET NULL',
                'CONSTRAINT location_resurfacer_updated_by_id_fk FOREIGN KEY (updated_by_id) REFERENCES user (id) ON UPDATE CASCADE ON DELETE SET NULL',
            ),
            'ENGINE = InnoDB DEFAULT CHARSET = utf8 COLLATE = utf8_unicode_ci AUTO_INCREMENT = 6'
        );
        /**
    ...
    private function createLocationStatusTable()
    {
        ...
        $this->createTable('location_status', array(
                ...
                'CONSTRAINT location_status_created_by_id_fk FOREIGN KEY (created_by_id) REFERENCES user (id) ON UPDATE CASCADE ON DELETE SET NULL',
                'CONSTRAINT location_status_updated_by_id_fk FOREIGN KEY (updated_by_id) REFERENCES user (id) ON UPDATE CASCADE ON DELETE SET NULL',
            ),
            'ENGINE = InnoDB DEFAULT CHARSET = utf8 COLLATE = utf8_unicode_ci AUTO_INCREMENT = 6'
        );
    }
    ...
    private function createLocationTable()
    {
        ...
        $this->createTable('location', array(
                ...
                'CONSTRAINT location_base_id_fk FOREIGN KEY (base_id) REFERENCES location_base (id) ON UPDATE CASCADE ON DELETE SET NULL',
                'CONSTRAINT location_refrigeration_id_fk FOREIGN KEY (refrigeration_id) REFERENCES location_refrigeration (id) ON UPDATE CASCADE ON DELETE SET NULL',
                'CONSTRAINT location_resurfacer_id_fk FOREIGN KEY (resurfacer_id) REFERENCES location_resurfacer (id) ON UPDATE CASCADE ON DELETE SET NULL',
                ...
                'CONSTRAINT location_created_by_id_fk FOREIGN KEY (created_by_id) REFERENCES user (id) ON UPDATE CASCADE ON DELETE SET NULL',
                'CONSTRAINT location_updated_by_id_fk FOREIGN KEY (updated_by_id) REFERENCES user (id) ON UPDATE CASCADE ON DELETE SET NULL',
            ),
            'ENGINE = InnoDB DEFAULT CHARSET = utf8 COLLATE = utf8_unicode_ci'
        );
    }
