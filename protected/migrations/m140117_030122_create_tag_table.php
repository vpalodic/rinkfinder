...
class m140117_030122_create_tag_table extends CDbMigration
{
    ...
    private function createTagTable()
    {
        ...
        $this->createTable('tag', array(
                ...
                'CONSTRAINT tag_created_by_id_fk FOREIGN KEY (created_by_id) REFERENCES user (id) ON UPDATE CASCADE ON DELETE SET NULL',
                'CONSTRAINT tag_updated_by_id_fk FOREIGN KEY (updated_by_id) REFERENCES user (id) ON UPDATE CASCADE ON DELETE SET NULL',
            ),
