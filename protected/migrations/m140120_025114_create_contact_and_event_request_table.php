...
class m140120_025114_create_contact_and_event_request_table extends CDbMigration
{
    ...
    private function createContactTable()
    {
        ...
        $this->createTable('contact', array(
                ...
                'CONSTRAINT contact_created_by_id_fk FOREIGN KEY (created_by_id) REFERENCES user (id) ON UPDATE CASCADE ON DELETE SET NULL',
                'CONSTRAINT contact_updated_by_id_fk FOREIGN KEY (updated_by_id) REFERENCES user (id) ON UPDATE CASCADE ON DELETE SET NULL',
            ),
    ...
    private function createEventRequestTypeTable()
    {
        ...
        $this->createTable('event_request_type', array(
                ...
                'CONSTRAINT event_request_type_created_by_id_fk FOREIGN KEY (created_by_id) REFERENCES user (id) ON UPDATE CASCADE ON DELETE SET NULL',
                'CONSTRAINT event_request_type_updated_by_id_fk FOREIGN KEY (updated_by_id) REFERENCES user (id) ON UPDATE CASCADE ON DELETE SET NULL',
            ),
    ...
    private function createEventRequestStatusTable()
    {
        ...
        $this->createTable('event_request_status', array(
                ...
                'CONSTRAINT event_request_status_created_by_id_fk FOREIGN KEY (created_by_id) REFERENCES user (id) ON UPDATE CASCADE ON DELETE SET NULL',
                'CONSTRAINT event_request_status_updated_by_id_fk FOREIGN KEY (updated_by_id) REFERENCES user (id) ON UPDATE CASCADE ON DELETE SET NULL',
            ),
    ...
    private function createEventRequestTable()
    {
        ...
        $this->createTable('event_request', array(
                ...
                'CONSTRAINT event_request_acknowledger_id_fk FOREIGN KEY (acknowledger_id) REFERENCES user (id) ON UPDATE CASCADE ON DELETE SET NULL',
                'CONSTRAINT event_request_accepter_id_fk FOREIGN KEY (accepter_id) REFERENCES user (id) ON UPDATE CASCADE ON DELETE SET NULL',
                'CONSTRAINT event_request_rejector_id_fk FOREIGN KEY (rejector_id) REFERENCES user (id) ON UPDATE CASCADE ON DELETE SET NULL',
                ...
                'CONSTRAINT event_request_created_by_id_fk FOREIGN KEY (created_by_id) REFERENCES user (id) ON UPDATE CASCADE ON DELETE SET NULL',
                'CONSTRAINT event_request_updated_by_id_fk FOREIGN KEY (updated_by_id) REFERENCES user (id) ON UPDATE CASCADE ON DELETE SET NULL',
            ),
            'ENGINE = InnoDB DEFAULT CHARSET = utf8 COLLATE = utf8_unicode_ci'
        );
    }
