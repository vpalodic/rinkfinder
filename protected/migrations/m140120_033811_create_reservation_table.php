...
class m140120_033811_create_reservation_table extends CDbMigration
{
    ...
    private function createReservationStatusTable()
    {
        ...
        $this->createTable('reservation_status', array(
                ...
                'CONSTRAINT reservation_status_created_by_id_fk FOREIGN KEY (created_by_id) REFERENCES user (id) ON UPDATE RESTRICT ON DELETE RESTRICT',
                'CONSTRAINT reservation_status_updated_by_id_fk FOREIGN KEY (updated_by_id) REFERENCES user (id) ON UPDATE RESTRICT ON DELETE RESTRICT',
            ),
    ...
    private function createReservationTable()
    {
        ...
        $this->createTable('reservation', array(
                ...
                'CONSTRAINT reservation_created_by_id_fk FOREIGN KEY (created_by_id) REFERENCES user (id) ON UPDATE RESTRICT ON DELETE RESTRICT',
                'CONSTRAINT reservation_updated_by_id_fk FOREIGN KEY (updated_by_id) REFERENCES user (id) ON UPDATE RESTRICT ON DELETE RESTRICT',
            ),
