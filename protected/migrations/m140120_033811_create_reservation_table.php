...
class m140120_033811_create_reservation_table extends CDbMigration
{
    ...
    private function createReservationStatusTable()
    {
        ...
        $this->createTable('reservation_status', array(
                ...
                'CONSTRAINT reservation_status_created_by_id_fk FOREIGN KEY (created_by_id) REFERENCES user (id) ON UPDATE CASCADE ON DELETE SET NULL',
                'CONSTRAINT reservation_status_updated_by_id_fk FOREIGN KEY (updated_by_id) REFERENCES user (id) ON UPDATE CASCADE ON DELETE SET NULL',
            ),
    ...
    private function createReservationTable()
    {
        ...
        $this->createTable('reservation', array(
                ...
                'CONSTRAINT reservation_source_id_fk FOREIGN KEY (source_id) REFERENCES event_request (id) ON UPDATE CASCADE ON DELETE SET NULL',
                ...
                'CONSTRAINT reservation_created_by_id_fk FOREIGN KEY (created_by_id) REFERENCES user (id) ON UPDATE CASCADE ON DELETE SET NULL',
                'CONSTRAINT reservation_updated_by_id_fk FOREIGN KEY (updated_by_id) REFERENCES user (id) ON UPDATE CASCADE ON DELETE SET NULL',
            ),
