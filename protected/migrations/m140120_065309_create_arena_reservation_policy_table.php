...
class m140120_065309_create_arena_reservation_policy_table extends CDbMigration
{
    ...
    private function createArenaReservationPolicyTable()
    {
        ...
        $this->createTable('arena_reservation_policy', array(
                ...
                'CONSTRAINT arena_reservation_policy_arena_id_fk FOREIGN KEY (arena_id) REFERENCES arena (id) ON UPDATE CASCADE ON DELETE RESTRICT',
                'CONSTRAINT arena_reservation_policy_event_type_id_fk FOREIGN KEY (event_type_id) REFERENCES event_type (id) ON UPDATE CASCADE ON DELETE RESTRICT',
                'CONSTRAINT arena_reservation_policy_created_by_id_fk FOREIGN KEY (created_by_id) REFERENCES user (id) ON UPDATE CASCADE ON DELETE RESTRICT',
                'CONSTRAINT arena_reservation_policy_updated_by_id_fk FOREIGN KEY (updated_by_id) REFERENCES user (id) ON UPDATE CASCADE ON DELETE RESTRICT',
            ),
