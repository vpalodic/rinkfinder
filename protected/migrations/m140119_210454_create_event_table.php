...
class m140119_210454_create_event_table extends CDbMigration
{
    ...
    private function createEventTypeTable()
    {
        ...
        $this->createTable('event_type', array(
                ...
                'CONSTRAINT event_type_created_by_id_fk FOREIGN KEY (created_by_id) REFERENCES user (id) ON UPDATE CASCADE ON DELETE SET NULL',
                'CONSTRAINT event_type_updated_by_id_fk FOREIGN KEY (updated_by_id) REFERENCES user (id) ON UPDATE CASCADE ON DELETE SET NULL',
            ),
    ...
    private function createEventStatusTable()
    {
        ...
        $this->createTable('event_status', array(
                ...
                'CONSTRAINT event_status_created_by_id_fk FOREIGN KEY (created_by_id) REFERENCES user (id) ON UPDATE CASCADE ON DELETE SET NULL',
                'CONSTRAINT event_status_updated_by_id_fk FOREIGN KEY (updated_by_id) REFERENCES user (id) ON UPDATE CASCADE ON DELETE SET NULL',
            ),
    ...
    private function createEventTable()
    {
        ...
        $this->createTable('event', array(
                ...
                'CONSTRAINT event_location_id_fk FOREIGN KEY (location_id) REFERENCES location (id) ON UPDATE CASCADE ON DELETE CASCADE',
                ...
                'CONSTRAINT event_created_by_id_fk FOREIGN KEY (created_by_id) REFERENCES user (id) ON UPDATE CASCADE ON DELETE SET NULL',
                'CONSTRAINT event_updated_by_id_fk FOREIGN KEY (updated_by_id) REFERENCES user (id) ON UPDATE CASCADE ON DELETE SET NULL',
            ),
