...
/**
 * This is the model class for table "ice_sheet_type".
 *
 * The followings are the available columns in table 'ice_sheet_type':
 * @property integer $id
 ...
 */
class IceSheetType extends RinkfinderActiveRecord
{
	/**
	...
	public function relations()
	{
		...
		return array(
			'iceSheets' => array(self::HAS_MANY, 'IceSheet', 'type_id'),
	 ...
	 * @return IceSheetType the static model class
	 */
