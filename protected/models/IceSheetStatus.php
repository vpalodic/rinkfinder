...
/**
 * This is the model class for table "ice_sheet_status".
 *
 * The followings are the available columns in table 'ice_sheet_status':
 * @property integer $id
 ...
 */
class IceSheetStatus extends RinkfinderActiveRecord
{
	/**
	...
	public function relations()
	{
		...
		return array(
			'iceSheets' => array(self::HAS_MANY, 'IceSheet', 'status_id'),
	 ...
	 * @return IceSheetStatus the static model class
	 */
