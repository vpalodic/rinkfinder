 ...
 *
 * The followings are the available columns in table 'reservation_status':
 * @property integer $id
 ...
 */
class ReservationStatus extends RinkfinderActiveRecord
{
	/**
	...
	public function relations()
	{
		...
		return array(
			'reservations' => array(self::HAS_MANY, 'Reservation', 'status_id'),
