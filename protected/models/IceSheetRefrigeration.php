...
/**
 * This is the model class for table "ice_sheet_refrigeration".
 *
 * The followings are the available columns in table 'ice_sheet_refrigeration':
 * @property integer $id
 ...
 */
class IceSheetRefrigeration extends RinkfinderActiveRecord
{
	/**
	...
	{
		return 'ice_sheet_refrigeration';
	}
	 ...
	 * @return IceSheetRefrigeration the static model class
	 */
