...
/**
 * This is the model class for table "event_request_type".
 *
 * The followings are the available columns in table 'event_request_type':
 * @property integer $id
 ...
 */
class EventRequestType extends RinkfinderActiveRecord
{
	/**
	...
	public function relations()
	{
		...
		return array(
			'eventRequests' => array(self::HAS_MANY, 'EventRequest', 'type_id'),
	 ...
	 * @return EventRequestType the static model class
	 */
