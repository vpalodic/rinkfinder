...
/**
 * This is the model class for table "reservation_request_type".
 *
 * The followings are the available columns in table 'reservation_request_type':
 * @property integer $id
 ...
 */
class ReservationRequestType extends RinkfinderActiveRecord
{
	/**
	...
	{
		return 'reservation_request_type';
	}
	...
	public function relations()
	{
		...
		return array(
			'reservationRequests' => array(self::HAS_MANY, 'ReservationRequest', 'type_id'),
	 ...
	 * @return ReservationRequestType the static model class
	 */
