...
/**
 * This is the model class for table "reservation_request_status".
 *
 * The followings are the available columns in table 'reservation_request_status':
 * @property integer $id
 ...
 */
class ReservationRequestStatus extends RinkfinderActiveRecord
{
	/**
	...
	{
		return 'reservation_request_status';
	}
	...
	public function relations()
	{
		...
		return array(
			'reservationRequests' => array(self::HAS_MANY, 'ReservationRequest', 'status_id'),
	 ...
	 * @return ReservationRequestStatus the static model class
	 */
