...
/**
 * This is the model class for table "event_request_status".
 *
 * The followings are the available columns in table 'event_request_status':
 * @property integer $id
 ...
 */
class EventRequestStatus extends RinkfinderActiveRecord
{
	/**
	...
	public function relations()
	{
		...
		return array(
			'eventRequests' => array(self::HAS_MANY, 'EventRequest', 'status_id'),
	 ...
	 * @return EventRequestStatus the static model class
	 */
