...
<h3 class="sectionSubHeader">IMPORTANT!!!</h3>
<p class="sectionSubHeaderContent">
    IMPORTANT! YOUR ACCESS TO THIS WEB SITE IS SUBJECT TO LEGALLY BINDING TERMS AND CONDITIONS. CAREFULLY READ ALL OF THE FOLLOWING TERMS AND CONDITIONS BEFORE PROCEEDING.
</p>
<p class="sectionSubHeaderContent">
    This is an agreement between you ("You") and MIAMA (the "Company"). The entities are all under the same ownership, and when referring to MIAMA in this policy, all three entities are being spoken for. "We" and "Us" means both You and the Company.
</p>

<h3 class="sectionSubHeader">Table of Contents</h3>
<p class="sectionSubHeaderContent">
    <ol>
        <li>
            <h4>OWNERSHIP AND COPYRIGHT</h4>
        </li>
        <li>
            <h4>PERMITTED USE</h4>
        </li>
        ...
        <li>
            <h4>LIMITATIONS ON LIABILITY AND DISCLAIMERS</h4>
        </li>
        <li>
            <h4>TERMINATION</h4>
        </li>
        ...
        <li>
            <h4>RETURN AND DELIVERY POLICIES</h4>
        </li>
    </ol>
</p>
<h3 class="sectionSubHeader">Terms of Use</h3>
<p class="sectionSubHeaderContent">
    <ol>
        <li>
            <h4>OWNERSHIP AND COPYRIGHT</h4>
        ...
        <li>
            <h4>INDEMNITY</h4>
            <p class="sectionSubHeaderContent">
                You agree at all times to indemnify, defend and hold harmless the Company, its agents, suppliers, affiliates and their respective directors and employees against all actions, proceedings, costs, claims, damages, demands, liabilities and expenses whatsoever (including legal and other fees and disbursements) sustained, incurred or paid by the Company directly or indirectly in respect of: (i) any information or other content You provide on or through this web site or which is sent to the Company by e-mail or other correspondence; or (ii) Your use or misuse of the Content or this web site, including without limitation infringement claims
            </p>
        </li>
        <li>
            <h4>INTERPRETATION</h4>
        ...
        <li>
            <h4>ONLINE REGISTRATION</h4>
            <p class="sectionSubHeaderContent">
                This site encrypts sensitive information and uses SSL technology where appropriate. MIAMA does not distribute sell or otherwise exploit this information in any way.
            </p>
        </li>
        <li>
            <h4>PAYMENT POLICY</h4>
            <p class="sectionSubHeaderContent">
                MIAMA allows users to pay online for services such as reserving ice that is for-sale and other related activities. The receipt and confirmation page that you receive upon completion of the process will serve as your successfully received “goods”.
            </p>
        </li>
        <li>
            <h4>RETURN AND DELIVERY POLICIES</h4>
            <p class="sectionSubHeaderContent">
                All sales made through the site are final. After completing online payment, you are brought immediately to a receipt and confirmation page. This page acknowledges that you have completed the process and the process payment. You are instructed to print that page for your records. This page is your receipt and your product. This receipt should be kept as an ongoing record of your successful payment completion. This receipt is also e-mailed to your specified address and a record of your order is also kept on the site, you may log into your account to also view a record of the order.
            </p>
            <p class="sectionSubHeaderContent">
                There are no refunds through the site. If you decide not to utilize the services for which you paid, you have the right to refrain from participating, however, no refunds are available. All sales through the site's system are final.
            </p>
            <p class="sectionSubHeaderContent">
                If you have questions about this return policy or need assistance please contact us by e-mailing rinkfinder@miama.org.
            </p>
        </li>
    </ol>
</p>